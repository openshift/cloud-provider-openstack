...
func TestSyncConfigFromFile(t *testing.T) {
	...
	th.AssertEquals(t, "id1", sc.ProjectDenyList[0])
	th.AssertEquals(t, "id2", sc.ProjectDenyList[1])
	th.AssertEquals(t, "name1", sc.ProjectNameDenyList[0])
	th.AssertEquals(t, "name2", sc.ProjectNameDenyList[1])
