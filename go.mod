...
replace (
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.28.14
	k8s.io/endpointslice => k8s.io/endpointslice v0.28.14
...
require (
	...
	k8s.io/csi-translation-lib v0.28.14 // indirect
	k8s.io/kube-openapi v0.0.0-20230717233707-2695361300d9 // indirect
	k8s.io/kubectl v0.28.14 // indirect
	k8s.io/kubelet v0.28.14 // indirect
	k8s.io/pod-security-admission v0.28.14 // indirect
